# Activity Python 2: Task 1
# File: HW_11P2_TASK1_UCscherzts.py
# Date:    16 Nov 2023
# By:      Tre Scherz
# Section: 014
# Team:    236
...
# This program will output the exercise intensity level and the calories burned per hour based on the type of machine used.
