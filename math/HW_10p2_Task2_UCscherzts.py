# Acticvity Python 1: Task 2
# File: HW_10P2_TASK2_UCscherzts.py
# Date:    2 Nov 2023
# By:      Tre Scherz
# Section: 014
# Team:    236
...
# A program for calculating the speed of a roller coaster at the bottom of the hill.  
# Using the car speed at position1, the friction coeffecient, the
# distance traveled, the initial elevation and the final elevation.
# This program will generate use v2.
